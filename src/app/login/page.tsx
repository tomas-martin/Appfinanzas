...
export default function LoginPage() {
  return (
    <div className="fixed inset-0 w-full h-full flex flex-col items-center justify-between bg-black text-white overflow-hidden p-6 select-none touch-none">
      ...
      {/* Lista de Capacidades (Punto Medio) */}
      <div className="w-full max-w-[320px] z-10 space-y-4">
        <div className="space-y-4 bg-white/[0.03] border border-white/10 rounded-[2rem] p-7 backdrop-blur-xl">
          <div className="flex items-center gap-4">
            <div className="w-9 h-9 rounded-full bg-indigo-500/10 flex items-center justify-center shrink-0">
              <TrendingUp className="w-4.5 h-4.5 text-indigo-400" />
            </div>
            <p className="text-[11px] font-bold text-white/80 uppercase tracking-widest">Seguimiento de Gastos</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-9 h-9 rounded-full bg-emerald-500/10 flex items-center justify-center shrink-0">
              <CreditCard className="w-4.5 h-4.5 text-emerald-400" />
            </div>
            <p className="text-[11px] font-bold text-white/80 uppercase tracking-widest">Control de Tarjetas</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-9 h-9 rounded-full bg-amber-500/10 flex items-center justify-center shrink-0">
              <DollarSign className="w-4.5 h-4.5 text-amber-400" />
            </div>
            <p className="text-[11px] font-bold text-white/80 uppercase tracking-widest">Cotización Dólar Blue</p>
          </div>
        </div>
      </div>

      {/* Footer y Botón (Punto Medio) */}
